...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            //박스 벽 충돌 확인
            bool isboxwallx = wallx == boxx;
            bool isboxwally = wally == boxy;
            bool isboxwall = isboxwallx && isboxwally;
            //박스 벽 충돌 확인2
            bool isboxwallx2 = wallx == boxx2;
            bool isboxwally2 = wally == boxy2;
            bool isboxwall2 = isboxwallx2 && isboxwally2;
            //박스간 충돌 확인
            ...
            {
                boxx = Math.Max(MapMinx, boxx - 1);
            }
            else if (isCollbox && input.Key == ConsoleKey.UpArrow)
            {
                boxy = Math.Max(MapMinx, boxy - 1);
            }
            ...
            //박스 벽 충돌 구현
            if (isboxwall && input.Key == ConsoleKey.LeftArrow)
            {
                ++boxx;
            }
            else if (isboxwall && input.Key == ConsoleKey.UpArrow)
            {
                ++boxy;
            }
            else if (isboxwall && input.Key == ConsoleKey.RightArrow)
            {
                --boxx;
            }
            else if (isboxwall && input.Key == ConsoleKey.DownArrow)
            {
                --boxy;
            }
            //박스 벽 충돌시 플레이어
            ...
            //박스 벽 충돌2 구현
            if (isboxwall2 && input.Key == ConsoleKey.LeftArrow)
            {
                ++boxx2;
            }
            else if (isboxwall2 && input.Key == ConsoleKey.UpArrow)
            {
                ++boxy2;
            }
            else if (isboxwall2 && input.Key == ConsoleKey.RightArrow)
            {
                --boxx2;
            }
            else if (isboxwall2 && input.Key == ConsoleKey.DownArrow)
            {
                --boxy2;
            }
            //박스 벽 충돌시 플레이어2
            ...
            //클리어 확인
            bool isSamegoal1 = ((goalx == boxx) && (goalx2 == boxx2)) || ((goalx2 == boxx) && (goalx == boxx2));
            bool isSamegoal2 = ((goaly == boxy) && (goalx2 == boxx2)) || ((goalx2 == boxx) && (goalx == boxx2));
            bool isCollgoal = isSamegoal1 && isSamegoal2;
